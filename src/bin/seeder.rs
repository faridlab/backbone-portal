//! Database seeder binary for module: portal
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Run with: cargo run --bin portal-seeder
//! Or via CLI: backbone seed run --module portal
//!
...
use backbone_portal::seeders::SeedPortalUserSeeder;
use backbone_portal::seeders::Seeder;
...
async fn main() -> Result<()> {
    ...
    println!();
    println!("Running seeders for module: portal");
    println!();
    ...
    seeders.push(Box::new(SeedPortalUserSeeder::new()));
