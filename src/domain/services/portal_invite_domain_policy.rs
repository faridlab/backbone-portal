//! Domain policy for PortalInvite aggregate
//!
...
/// Domain policy for PortalInvite — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<PortalInvite>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type PortalInviteDomainPolicy = PermitAllPolicy<PortalInvite>;
