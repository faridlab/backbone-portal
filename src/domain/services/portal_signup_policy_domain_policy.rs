//! Domain policy for PortalSignupPolicy aggregate
//!
...
/// Domain policy for PortalSignupPolicy — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<PortalSignupPolicy>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type PortalSignupPolicyDomainPolicy = PermitAllPolicy<PortalSignupPolicy>;
