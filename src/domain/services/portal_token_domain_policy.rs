//! Domain policy for PortalToken aggregate
//!
...
/// Domain policy for PortalToken — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<PortalToken>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type PortalTokenDomainPolicy = PermitAllPolicy<PortalToken>;
