//! Specifications for PortalAuditLog aggregate
//!
...
// Each predicate implements `Specification<PortalAuditLog>` and can be combined
...
//
// pub struct ActivePortalAuditLogSpec;
// impl Specification<PortalAuditLog> for ActivePortalAuditLogSpec {
//     fn is_satisfied_by(&self, e: &PortalAuditLog) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
