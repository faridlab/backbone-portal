//! Specifications for PortalInvite aggregate
//!
...
// Each predicate implements `Specification<PortalInvite>` and can be combined
...
//
// pub struct ActivePortalInviteSpec;
// impl Specification<PortalInvite> for ActivePortalInviteSpec {
//     fn is_satisfied_by(&self, e: &PortalInvite) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
