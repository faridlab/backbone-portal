//! Specifications for PortalToken aggregate
//!
...
// Each predicate implements `Specification<PortalToken>` and can be combined
...
//
// pub struct ActivePortalTokenSpec;
// impl Specification<PortalToken> for ActivePortalTokenSpec {
//     fn is_satisfied_by(&self, e: &PortalToken) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
