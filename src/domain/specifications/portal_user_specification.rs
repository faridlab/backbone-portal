//! Specifications for PortalUser aggregate
//!
...
// Each predicate implements `Specification<PortalUser>` and can be combined
...
//
// pub struct ActivePortalUserSpec;
// impl Specification<PortalUser> for ActivePortalUserSpec {
//     fn is_satisfied_by(&self, e: &PortalUser) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
